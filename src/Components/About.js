...
function About() {
    return (
        <div className='about' >
            <p className='intro'>This YouTube Clone project uses the YouTube API data to mimic YouTube's functionality.  On this application, you will be able to search videos by keyword, view selected videos and leave comments.  Happy viewing!</p>
            <div className='developers'>
                <div className='Kylie'>
                    <img src='./Kylie.jpg' alt='Kylie'></img>
                    ...
                    <p>Please follow my other work on <a href='https://github.com/Kylie-Lang1'>GitHub</a>.  You can also connect with me on <a href='https://www.linkedin.com/in/kylie-lang-8ba021207/'>LinkedIn</a>.</p>
                </div>
